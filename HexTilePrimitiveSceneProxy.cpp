...
FHexTilePrimitiveSceneProxy::FHexTilePrimitiveSceneProxy(const UHexTilePrimitive* InComponent)
...
FHexTilePrimitiveSceneProxy::~FHexTilePrimitiveSceneProxy()
{
}

void FHexTilePrimitiveSceneProxy::GetDynamicMeshElements(const TArray<const FSceneView*>& Views, 
	...
	FMeshElementCollector& Collector) const
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("FHexTilePrimitiveSceneProxy: No geometry data to render"));
		return;
	}
	...
	if (!Material || !Material->IsValidLowLevel())
	{
		UE_LOG(LogTemp, Warning, TEXT("FHexTilePrimitiveSceneProxy: Invalid material"));
		return;
	}
...
FPrimitiveViewRelevance FHexTilePrimitiveSceneProxy::GetViewRelevance(const FSceneView* View) const
{
...
SIZE_T FHexTilePrimitiveSceneProxy::GetTypeHash() const
{
	static SIZE_T UniquePointer;
	return reinterpret_cast<SIZE_T>(&UniquePointer);
}

uint32 FHexTilePrimitiveSceneProxy::GetMemoryFootprint() const
{
